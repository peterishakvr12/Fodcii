...
const mockLeaderboard = [
  { rank: 1, name: "Alex Chen", avatar: "", email: "alex.chen@example.com", solvedProblems: 98, totalProblems: 110, points: 2450, streak: 15, level: "Expert" },
  { rank: 2, name: "Sarah Johnson", avatar: "", email: "sarah.j@example.com", solvedProblems: 89, totalProblems: 110, points: 2180, streak: 8, level: "Advanced" },
  { rank: 3, name: "Michael Rodriguez", avatar: "", email: "m.rodriguez@example.com", solvedProblems: 82, totalProblems: 110, points: 1950, streak: 12, level: "Advanced" },
  { rank: 4, name: "Emily Davis", avatar: "", email: "emily.davis@example.com", solvedProblems: 76, totalProblems: 110, points: 1820, streak: 5, level: "Intermediate" },
  { rank: 5, name: "David Kim", avatar: "", email: "david.kim@example.com", solvedProblems: 71, totalProblems: 110, points: 1690, streak: 9, level: "Intermediate" },
  { rank: 6, name: "Lisa Wang", avatar: "", email: "lisa.wang@example.com", solvedProblems: 68, totalProblems: 110, points: 1580, streak: 3, level: "Intermediate" },
  { rank: 7, name: "James Wilson", avatar: "", email: "james.w@example.com", solvedProblems: 63, totalProblems: 110, points: 1450, streak: 7, level: "Intermediate" },
  { rank: 8, name: "Maria Garcia", avatar: "", email: "maria.g@example.com", solvedProblems: 58, totalProblems: 110, points: 1320, streak: 4, level: "Beginner" },
]
